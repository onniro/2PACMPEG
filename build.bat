...
set LINK_LIBS=-static-libstdc++ -static -lunwind -lopengl32 -lgdi32 -lshell32 -lole32 $PWD/deps/GLFW/linux/libglfw3.a -luuid -lwinmm -lshlwapi %OBJ_FILES%
REM set MISC_FLAGS=-O2 -o 2PACMPEG.EXE -g -gcodeview --for-linker --pdb=2pacmpeg.pdb -Wl,/subsystem:windows,/opt:ref,/DEBUG:FULL
set MISC_FLAGS=-O2 -o 2PACMPEG.EXE -gdwarf -Wl,/subsystem:windows,/opt:ref
