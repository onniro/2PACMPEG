...
REM set MISC_FLAGS=-o 2PACMPEG.EXE -g -gcodeview --for-linker --pdb=2pacmpeg.pdb -Wl,/subsystem:windows,/opt:ref
set MISC_FLAGS=-o 2PACMPEG.EXE -gdwarf -Wl,/subsystem:windows,/opt:ref
