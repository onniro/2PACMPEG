...
static void platform_execute_command(text_buffer_group *tbuf_group, platform_thread_info *thread_info, runtime_vars *rt_vars, bool8 detach);
...
static DWORD win32_get_deltatime_ms(LONGLONG start, LONGLONG end, LONGLONG perfcounter_freq);
static void win32_con_write(char *buf, int buf_bytes);
